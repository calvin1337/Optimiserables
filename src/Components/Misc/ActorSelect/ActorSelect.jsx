...
function ActorSelect() {
  ...
  const actors = [
    { name: 'Michael Garden', 
      ...
      socials: [
        {platform: 'Instagram', link: 'https://www.instagram.com/michaeljg212/'},
        {platform: 'Spotlight', link: 'https://app.spotlight.com/2210-7837-6789'},
        {platform: 'X', link: 'https://x.com/MichaelJGarden1'}
      ],
      wardrobe: [
        {src:'https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg', style: 'Original'},
        {src: 'https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg', style:'Hue Rotate 90', className: 'hue-rotate-90'}
      ]
    },
    ...
    { name: 'Finlay Donald', 
      ...
      socials: [
        {platform: 'Instagram', link: 'https://www.instagram.com/finlaywilldonald/?next=%2F'}
      ]
    },
