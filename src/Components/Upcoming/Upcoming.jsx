...
const Upcoming = () => (
  <div className="flex flex-col items-center w-screen h-screen"> 
    <div className="flex flex-col w-full md:w-5/6 h-full pt-5 pb-5">
      <UpcomingTitle />
      <div className='flex flex-col lg:flex-row w-full h-4/5 md:p-4 gap-5'>
        ...
        <div className="w-full md:w-1/2 flex flex-col md:flex-col justify-center items-center h-2/5 md:h-4/5 relative md:p-10">
          <div className="relative w-4/5 h-full">
           ...
           <ul id="countdown" className="relative w-full mx-auto p-4 text-white border-y-2 border-[#6A3276] font-narrow font-bold flex justify-around">
              <li className="flex flex-col items-center">
                <div className="text-[3vw] md:text-[4vw] lg:text-[3vw]">00</div>
         ...
         {/* Content Container */}
         <div className='w-full lg:w-1/2 h-2/5 md:h-4/5 flex flex-col gap-4 justify-center items-center'>
            ...
            <a href="https://example.com/buy-tickets" target="_blank" rel="noopener noreferrer" className="text-white py-1 px-2 md:py-2 md:px-4 rounded hover:opacity-80" style={{ backgroundColor: "#6A3276" }}>
              Get Notified
            </a>
        </div>
       {/* Video Container */}
