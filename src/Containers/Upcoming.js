...
export default function Upcoming() {
  return (
    <div className="container flex flex-col items-center w-5/6 page h-screen">
      <div className="flex text-left w-full ">
        <h1 className="lg:text-8xl tracking-widest">Upcoming Shows</h1>
      </div>
      <div className="flex w-full">
        <div className="flex-1  pt-4 pr-4 flex flex-row">
          <img
            src={baldo}
          ...
          <div className="flex flex-col text-left pl-3">
            <h2 className="text-2xl">DATE - TBA</h2>
            <h3 className="text-4xl text-white">Baldo Bros</h3>
            <p className="text-xs text-white pt-4 pb-4">
              ...
              hair-covered sibling, Calvin. In their quest to create a website
            ...
            <div className="flex flex-row items-end justify-between h-full space-x-4 mt-4">
              <a
                ...
                className="border-2 border-[#703B71] text-[#703B71] py-2 px-4 rounded hover:bg-[#703B71] hover:text-black transition-colors duration-300"
              >
                Read More
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white py-[10px] px-[16px] rounded hover:opacity-80"
